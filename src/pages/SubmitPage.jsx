...
const FormField = ({ label, placeholder, textarea, value, onChange, name }) => (
  <div>
    ...
    return (
      <div className="max-w-3xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-slate-600 mb-8">
          3~5영업일 내에 검토 후 연락드리겠습니다. 공개 전 반드시 최종 확인 메일을 드립니다.
        </p>
        <button
    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="mb-10">
        ...
        <p className="text-lg text-slate-600">
          작은 자동화도 누군가에게는 큰 힌트가 됩니다. 제보하신 내용은 검수 후 공개되며, 익명·가명
          처리가 가능합니다.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-slate-200 rounded-xl p-8">
        ...
        <FormField
          name="submitterInfo"
          label="제보자 (내부 확인용, 공개 안 됨)"
          placeholder="이름 · 직책 · 이메일"
          value={form.submitterInfo}
          onChange={handleChange}
        />
        ...
        <button
          type="submit"
          className="w-full py-3 bg-blue-900 text-white font-medium rounded-md hover:bg-blue-800 transition"
        >
          제보 제출하기
        </button>
